...
import { NewsItem } from "../src/entities/NewsItem";
...
import TickerGrid from "../src/components/dashboard/TickerGrid";
import NewsPanel from "../src/components/dashboard/NewsPanel";
...
export default function Dashboard() {
  ...
  const gainers = tickers.filter(t => t.price_change > 0).slice(0, 5);
  const losers = tickers.filter(t => t.price_change < 0).slice(0, 5);
